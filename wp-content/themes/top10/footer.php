...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-59051585-14"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-59051585-14');
</script>
<div id="fb-root"></div>
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.0&appId=948688801811893&autoLogAppEvents=1';
